...
def test_contains_no_match_raises_instead_of_inventing_zero():
...
if __name__ == "__main__":
    ...
    test_simple_contains_is_validated_without_lambda_rewrite()
    test_contains_no_match_raises_instead_of_inventing_zero()
